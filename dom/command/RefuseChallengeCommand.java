	...
	public void process() throws CommandException {
		...
		try {
			...
			if(helper.getSessionAttribute("userID") != null) {
				...
				if(ch.getStatus() != 0) {
					String msg = "You cannot refuse a challenge the status of which is not open.";
					throw new CommandException(msg);	
				}
				
				long userID = (long)helper.getSessionAttribute("userID");
				
				if(userID == ch.getChallengeeID()) {
				...
				} else if(userID == ch.getChallengerID()) {
					String msg = "Only Challengee can refuse a challenge.";
					throw new CommandException(msg);
				} else {
					String msg = "You cannot refuse a challenge that you are not included.";
					throw new CommandException(msg);
				}
